                ...
                <div class="col-lg-12">
                    <div class="banner_content text-center">
                        ...
                        <ul class="breadcrumb justify-content-center">
                            ...
                            <li><a class="active" href="#">{{__('lang.bilim_kurulu')}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section_title text-center pb-20">
                        <h3 class="main_title">{{ __('lang.bilim_kurulu') }}</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single_courses courses_gray mt-30">
                            ...
                            <div class="courses_content" style="height: 110px;">
                                ...
                                <h4 class="title"><a href="{{ route('bilimKuruluDetay', $team->id) }}">{!! $team->getTranslatedAttribute('name', app()->getLocale(), 'fallbackLocale') !!}</a></h4>
                                <div class="courses_author d-flex">
                                    <div class="author_name media-body">
                                        <a href="{{ route('bilimKuruluDetay', $team->id) }}"><i class="fa fa-map-marker"></i> {!! $team->getTranslatedAttribute('title', app()->getLocale(), 'fallbackLocale') !!}</a>
                                    </div>
                                </div>
