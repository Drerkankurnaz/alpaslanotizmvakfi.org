            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner_content text-center">
                        <h4 class="title">{{__('lang.kalite_cevre_is_sagligi_ve_guvenlik_politikasi')}}</h4>
                        <ul class="breadcrumb justify-content-center">
                            <li><a href="#">Ana Sayfa</a></li>
                            <li><a class="active" href="#">{{__('lang.kalite_cevre_is_sagligi_ve_guvenlik_politikasi')}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
