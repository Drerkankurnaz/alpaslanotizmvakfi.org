            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner_content text-center">
                        <h4 class="title">  {!! $service->getTranslatedAttribute('title', app()->getLocale(), 'fallbackLocale') !!}</h4>
                        <ul class="breadcrumb justify-content-center">
                            <li><a href="#">{{__('lang.ana_sayfa')}}</a></li>
                            <li><a class="active" href="#">  {!! $service->getTranslatedAttribute('title', app()->getLocale(), 'fallbackLocale') !!}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="blog_details mt-50">
                        {!! $service->getTranslatedAttribute('content', app()->getLocale(), 'fallbackLocale') !!}
