            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner_content text-center">
                        <h4 class="title">{{__('lang.temel_degerler')}}</h4>
                        <ul class="breadcrumb justify-content-center">
                            <li><a href="{{'/'}}">{{__('lang.ana_sayfa')}}</a></li>
                            <li><a class="active" href="javascript:;">{{__('lang.temel_degerler')}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="blog_details mt-50">
                        ...
                        <blockquote class="blockquote">
                            ...
                            <o>    {!! $about->getTranslatedAttribute('content_two', app()->getLocale(), 'fallbackLocale') !!}</o>
                        </blockquote>

                        <div class="details_image" style="margin-top: 30px;">
                            <img src="{{asset('storage/'.$about->photo)}}" alt="blog">
                        </div>
                    </div>
