            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner_content text-center">
                        <h4 class="title">  {!! $ct->getTranslatedAttribute('title', app()->getLocale(), 'fallbackLocale') !!}</p></h4>
                        <ul class="breadcrumb justify-content-center">
                            <li><a href="#">{{__('lang.ana_sayfa')}}</a></li>
                            <li><a class="active" href="#">  {!! $ct->getTranslatedAttribute('title', app()->getLocale(), 'fallbackLocale') !!}</p></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="blog_details mt-50">
                        ...
                        {!! $ct->getTranslatedAttribute('content', app()->getLocale(), 'fallbackLocale') !!}</p>


                        <div class="details_image" style="margin-top: 30px;">
                            <img src="{{asset('storage/'.$ct->photo)}}" alt="blog">
                        </div>
                    </div>
