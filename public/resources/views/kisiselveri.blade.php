...
@section('maincontent')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner_content text-center">
                        <h4 class="title">{{__('lang.kisisel_verileri_koruma_kanunu')}}</h4>
                        <ul class="breadcrumb justify-content-center">
                            <li><a href="#">{{__('lang.ana_sayfa')}}</a></li>
                            <li><a class="active" href="#">{{__('lang.kisisel_verileri_koruma_kanunu')}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="blog_details_page pt-80 pb-130">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <a href="{{ route('download.pdf') }}" class="btn btn-primary">PDF Olarak İndir</a>
