            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner_content text-center">
                        <h4 class="title"> {!! $activity->getTranslatedAttribute('title', app()->getLocale(), 'fallbackLocale') !!}</h4>
                        <ul class="breadcrumb justify-content-center">
                            <li><a href="#">Ana Sayfa</a></li>
                            <li><a class="active" href="#">{!! $activity->getTranslatedAttribute('title', app()->getLocale(), 'fallbackLocale') !!}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="blog_details mt-50">
                        {!! $activity->getTranslatedAttribute('content', app()->getLocale(), 'fallbackLocale') !!}
                    </div>
                </div>
                <div class="col-lg-4">
