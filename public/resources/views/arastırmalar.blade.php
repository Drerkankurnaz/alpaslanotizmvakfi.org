            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner_content text-center">
                        <h4 class="title">{{__('lang.arastırmalar')}}</h4>
                        <ul class="breadcrumb justify-content-center">
                            <li><a href="{{'/'}}">{{__('lang.ana_sayfa')}}</a></li>
                            <li><a class="active" href="#">{{__('lang.arastırmalar')}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="single_blog mt-30">
                            ...
                            <div class="blog_content" style="padding-top: 90px;">
                                <div class="blog_content_wrapper">
                                    <h4 class="blog_title"><a href="{{route('arastırma', ['id' => $content->title])}} ">{!! $content->getTranslatedAttribute('title', app()->getLocale(), 'fallbackLocale') !!}</a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
